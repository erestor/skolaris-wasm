...
LDFLAGSBUILD = -O3 -flto -L${LIBBOOST} -lboost_filesystem -Wl,-rpath,/usr/local/lib/boost
endif
...
LDFLAGSBUILD = -pthread -L${LIBBOOST}
endif
...
SOURCES_CPP = \
	...
	$(wildcard src/gascheduler/src/timetable/prep/*.cpp) \
